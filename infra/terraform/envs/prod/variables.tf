...
variable "route53_zone_id" {
  type        = string
  description = "Route53 Hosted Zone ID for badgers.nl when the zone already exists. If empty, Terraform creates a new public zone badgers.nl and migrates apex/MX/legacy A records from the old DNS export."
  default     = ""
  validation {
